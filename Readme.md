...
![Octopus Puppet](/docs/img/icon-512x512.png?raw=true "Octopus Puppet")
...
Provides a way run Octopus Puppet from Teamcity so that you can orchestrate differential deployments in Octopus.
