...
namespace OctopusPuppet.Cmd
{
    ...
    class Program
    {
        ...
        private static int BranchDeployment(BranchDeploymentOptions opts)
        {
            ...
            var redeployDeploymentPlans = deploymentPlanner.GetBranchDeploymentPlans(opts.TargetEnvironment, opts.Branch, opts.DoNotUseDifferentialDeployment, opts.ExcludeMasterBranch, componentFilter);
        ...
        private static int MirrorEnvironment(MirrorEnvironmentOptions opts)
        {
            ...
            var environmentMirrorDeploymentPlans = deploymentPlanner.GetEnvironmentMirrorDeploymentPlans(opts.SourceEnvironment, opts.TargetEnvironment, opts.DoNotUseDifferentialDeployment, opts.ExcludeMasterBranch, componentFilter);
